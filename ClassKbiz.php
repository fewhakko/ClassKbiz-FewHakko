...
class kbizbyfeweiei {
	...
	function login() {
		...
		CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
		CURLOPT_CUSTOMREQUEST => 'POST',
		CURLOPT_POSTFIELDS => "userName=".$this->response["username"]."&password=".$this->response["password"]."&tokenId=11229096910&cmd=authenticate&locale=th&custType=&captcha=&app=0",
